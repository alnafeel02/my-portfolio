...
function About() {
  return (
    <section className=' mx-auto  font-poppins w-full h-full '>
        <h1 className='mt-6 pt-20 text-5xl ms-4'>About Me</h1>
